...
const ismMoralData: IsmWord[] = [
  {
    arabic: "أَعْمَال",
    urdu: "اعمال، کام، کارنامے",
    english: "actions, deeds, works",
    frequency: 41
  },
  {
    arabic: "حَسَنَة، حَسَنَات",
    urdu: "نیکی، اچھا عمل",
    english: "good (deed)",
    frequency: 31
  },
  {
    arabic: "سَيِّئَة، سَيِّئَات",
    urdu: "برائی، برا عمل",
    english: "evil, bad",
    frequency: 58
  },
  ...
  {
    arabic: "اِسْم، أَسْمَاء",
    urdu: "نام",
    english: "name",
    frequency: 39
  },
  {
    arabic: "حَدِيْث، أَحَادِيْث",
    urdu: "گفتگو، بیان",
    english: "discourse; speech",
    frequency: 28
  },
  {
    arabic: "بَأْس",
    urdu: "عذاب، طاقت، مصیبت",
    english: "punishment; power; adversity",
    frequency: 25
  },
  {
    arabic: "نَصِيْب",
...
interface IsmLesson10ScreenProps {
  onBack: () => void;
}

export const IsmLesson10Screen: React.FC<IsmLesson10ScreenProps> = ({ onBack }) => {
  ...
  const totalWords = ismMoralData.length;
  const totalOccurrences = ismMoralData.reduce((sum, word) => sum + word.frequency, 0);
  const averageFrequency = Math.round(totalOccurrences / totalWords);

  // Use original sequence as provided
  const sortedData = ismMoralData;

  // Group data by categories
  const actions = sortedData.slice(0, ); // أعمال
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
        {/* Lesson Introduction */}
        <Text style={styles.lessonTitle}>اخلاقی تصورات</Text>
        <Text style={styles.lessonTitleEnglish}>Moral Concepts</Text>
        <Text style={styles.lessonSubtitle}>
          قرآن کریم میں اعمال، نیکی، برائی اور اخلاقی معیارات سے متعلق اہم الفاظ
        </Text>
        ...
        <View style={styles.noteCard}>
          ...
          <Text style={styles.noteText}>
            یہ الفاظ قرآن کریم کے اخلاقی نظام کو سمجھنے کے لیے بنیادی اہمیت رکھتے ہیں۔ نیکی اور برائی کا فرق انسانی زندگی کا بنیادی اصول ہے۔
          </Text>
        </View>
      </ScrollView>
    </View>
