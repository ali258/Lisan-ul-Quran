...
interface FalLesson1ScreenProps {
...
const FalLesson1Screen: React.FC<FalLesson1ScreenProps> = ({ onNavigate, onBack }) => {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.title}> فَعَلَ ، یَفْعَلُ</Text>
...
export default FalLesson1Screen; 