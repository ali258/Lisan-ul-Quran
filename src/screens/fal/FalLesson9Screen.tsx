...
interface FalLesson9ScreenProps {
...
const FalLesson9Screen: React.FC<FalLesson9ScreenProps> = ({ onNavigate, onBack }) => {
  ...
  const verbData = [
    ...
    },
    {
      ...
      mafool: 'مَأْمُوْن',
      masdar: 'أَمْن',
      urduTranslation: 'محفوظ ہونا، اعتماد کرنا',
      occurrence: 43,
    },
    {
      mazi: 'أَذِنَ',
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.title}> مہموز </Text>
          <Text style={styles.subtitle}>وہ افعال جن کے کسی بھی تینوں حروف میں "ہمزہ" آجائے۔</Text>
...
export default FalLesson9Screen; 