...
interface FalLesson5ScreenProps {
...
const FalLesson5Screen: React.FC<FalLesson5ScreenProps> = ({ onNavigate, onBack }) => {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.title}> مِثال </Text>
          <Text style={styles.subtitle}>وہ افعال جن کا پہلا حرف "و" یا "ی" ہو۔</Text>
...
export default FalLesson5Screen; 