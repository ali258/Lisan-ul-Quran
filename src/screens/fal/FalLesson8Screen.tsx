...
interface FalLesson8ScreenProps {
...
const FalLesson8Screen: React.FC<FalLesson8ScreenProps> = ({ onNavigate, onBack }) => {
  ...
  const verbData = [
    {
      ...
      mafool: 'مَظْنُوْن',
      masdar: 'ظَنّ',
      urduTranslation: 'سوچنا، گمان کرنا',
      occurrence: 69,
    },
    {
      mazi: 'رَدَّ',
      ...
      mafool: 'مَرْدُوْد',
      masdar: 'رَدّ',
      urduTranslation: 'واپس کرنا، لوٹانا',
      occurrence: 44,
    },
    {
      mazi: 'صَدَّ',
      ...
      mafool: 'مَصْدُوْد',
      masdar: 'صَدّ',
      urduTranslation: 'روکنا، منہ پھیرنا',
      occurrence: 39,
    },
    {
      mazi: 'ضَرَّ',
      ...
      mafool: 'مَضْرُوْر',
      masdar: 'ضَرّ',
      urduTranslation: 'نقصان پہنچانا، تکلیف دینا',
      occurrence: 31,
    },
    {
      mazi: 'غَرَّ',
    ...
    },
    {
      ...
      mafool: 'مَمْدُوْد',
      masdar: 'مَدّ',
      urduTranslation: 'پھیلانا، لمبا کرنا',
      occurrence: 17,
    },
    {
      mazi: 'ضَلَّ',
      ...
      fail: 'ضَالّ',
      mafool: 'مَضْلُوْل',
      masdar: 'ضَلَالَة ضَلَال',
      urduTranslation: 'گمراہ ہونا، بھٹکنا',
      occurrence: 114,
    },
    {
      mazi: 'حَقَّ',
      ...
      mafool: 'مَحْقُوْق',
      masdar: 'حَقّ',
      urduTranslation: 'ثابت کرنا، سچ ہونا',
      occurrence: 20,
    },
    {
      mazi: 'فَرَّ',
      ...
      mafool: 'مَفْرُوْر',
      masdar: 'فِرَار',
      urduTranslation: 'بھاگنا، فرار ہونا',
      occurrence: 10,
    },
    {
      mazi: 'مَسَّ',
    ...
    },
    {
      ...
      mafool: '',
      masdar: 'ظِلّ',
      urduTranslation: 'ہو جانا، بن جانا',
      occurrence: 9,
    },
    {
      mazi: 'وَدَّ',
      ...
      mafool: 'مَوْدُوْد',
      masdar: 'وُدّ',
      urduTranslation: 'محبت کرنا، چاہنا',
      occurrence: 18,
    },
    {
      mazi: 'حَيَّ',
      ...
      mafool: '',
      masdar: 'حَيَاة',
      urduTranslation: 'زندہ رہنا، سلام کرنا',
      occurrence: 83,
    },
  ];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.title}> مضاعف </Text>
          <Text style={styles.subtitle}>وہ افعال جن کے آخری دو حروف ایک جیسے ہوں (تکرار ہو)۔</Text>
...
export default FalLesson8Screen; 