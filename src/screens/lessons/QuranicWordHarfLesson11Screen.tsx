  ...
  const particles = [
    {
      ...
      urduMeaning: 'جب / (future)when',
      englishMeaning: '(future) when',
      reference: 'النصر 110:1',
    },
    {
      arabic: 'إِنْ',
      transliteration: 'in',
    ...
    {
      arabic: 'كُلَّمَا',
      transliteration: 'kullama',
      urduMeaning: 'جب جب / whenever',
      englishMeaning: 'whenever',
      reference: 'النساء 4:56',
    },
    {
      arabic: 'لَمَّا',
      ...
      urduMeaning: 'جب / when',
      englishMeaning: 'when',
      reference: 'يوسف 12:15',
    },
    {
      arabic: 'لَوْ',
      transliteration: 'law',
      urduMeaning: 'اگر (کاش) / if only',
      englishMeaning: 'if only',
      reference: 'البقرة 2:253',
    },
    {
      arabic: 'لَوْلَا',
      transliteration: 'lawla',
      urduMeaning: 'کیوں نہیں / if not',
      englishMeaning: 'if not',
      reference: 'يونس 10:20',
    },
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Harf Lesson 11</Text>
      </View>
