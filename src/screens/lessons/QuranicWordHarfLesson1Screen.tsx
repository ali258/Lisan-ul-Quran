  ...
  const particles = [
    {
      ...
      urduMeaning: 'except / سوائے',
      englishMeaning: 'except',
      reference: 'العصر 103:3',
    },
    {
      arabic: 'إِنَّمَا',
      transliteration: 'innama',
      urduMeaning: 'only / صرف',
      englishMeaning: 'only',
      reference: 'الحجرات 49:10',
    },
    {
      arabic: 'لَا',
      transliteration: 'la',
      urduMeaning: 'not / نہیں',
      englishMeaning: 'not',
      reference: 'البقرة 2:38',
    },
    {
      arabic: 'مَا',
      transliteration: 'ma',
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Harf Lesson 1</Text>
      </View>
      ...
      >
        ...
        <Text style={styles.lessonGroup}>
          حروف الابتداء والحصر
        </Text>
        <Text style={styles.subtitle}>
          Particles of Commencement and Restriction/Exclusivity
        </Text>
          ...
          {particles.map((particle, index) => (
            <View key={index} style={styles.particleCard}>
              ...
              <View style={styles.exampleSection}>
                <Text style={styles.exampleTitle}>Quranic Example</Text>
