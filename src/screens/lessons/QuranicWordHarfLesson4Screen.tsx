  ...
  const particles = [
    {
      arabic: 'عَسَى',
      transliteration: 'asa',
      urduMeaning: 'perhaps / شاید',
      englishMeaning: 'perhaps',
      reference: 'الإسراء 17:8',
    },
    {
      arabic: 'كَيْ',
      transliteration: 'kay',
      urduMeaning: 'so that / تاکه',
      englishMeaning: 'so that',
      reference: 'الحشر 59:7',
    },
    {
      arabic: 'كَيْلاَ',
      transliteration: 'kayla',
      urduMeaning: 'so that not / تاکه نه',
      englishMeaning: 'so that not',
      reference: 'النحل 16:70',
    },
    {
      arabic: 'لَعَلَّهُ',
      transliteration: 'la\'allahu',
      urduMeaning: 'perhaps / شاید',
      englishMeaning: 'perhaps',
      reference: 'البقرة 2:183',
    },
    {
      arabic: 'لِكَيْ',
      transliteration: 'lakay',
      urduMeaning: 'so that / تاکه',
      englishMeaning: 'so that',
      reference: 'الحديد 57:23',
    },
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Harf Lesson 4</Text>
      </View>
      ...
      >
        ...
        <Text style={styles.lessonGroup}>
          حروف التحقيق / التخفيف
        </Text>
        <Text style={styles.subtitle}>
          Particles of Verification / Lightening
        </Text>
        <Text style={styles.subtitle}>
          (Hope / Causation)
        </Text>
