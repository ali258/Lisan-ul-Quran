...
interface QuranicWordHarfLesson16ScreenProps {
...
const QuranicWordHarfLesson16Screen: React.FC<QuranicWordHarfLesson16ScreenProps> = ({ onNavigate, onBack }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>حرف شرط </Text>
      </View>
      ...
      >
        {/* Title Section */}
        <Text style={styles.title}>🔤 حرف شرط - Conditional Particles</Text>
        <Text style={styles.subtitle}>
          Learn essential Arabic conditional particles and their usage in the Quran
        </Text>
        ...
        <View style={styles.particlesContainer}>
          {particles.map((particle, index) => (
            <View key={index} style={styles.particleCard}>
              ...
              <View style={styles.exampleSection}>
                <Text style={styles.exampleTitle}>Translation</Text>
...
export default QuranicWordHarfLesson16Screen; 