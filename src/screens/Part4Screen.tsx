...
import Part4Lesson1Screen from './arabic/Part4Lesson1Screen';
import Part4Lesson2Screen from './arabic/Part4Lesson2Screen';
import Part4Lesson3Screen from './arabic/Part4Lesson3Screen';
import Part4Lesson4Screen from './arabic/Part4Lesson4Screen';
import Part4Lesson5Screen from './arabic/Part4Lesson5Screen';
import Part4Lesson6Screen from './arabic/Part4Lesson6Screen';
import Part4Lesson7Screen from './arabic/Part4Lesson7Screen';
import Part4Lesson8Screen from './arabic/Part4Lesson8Screen';
import Part4Lesson9Screen from './arabic/Part4Lesson9Screen';
import Part4Lesson10Screen from './arabic/Part4Lesson10Screen';
...
interface Part4ScreenProps {
  onGoToSettings?: () => void;
  onBottomNavigation?: (menuId: string) => void;
  onBackPress?: () => void;
}

const Part4Screen: React.FC<Part4ScreenProps> = ({ 
  onGoToSettings, 
  onBottomNavigation, 
  onBackPress 
}) => {
        ...
        <View style={styles.statsSection}>
          ...
          <View style={styles.statsRow}>
            <View style={styles.statItem}>
              <Text style={styles.statNumber}>{part4Lessons.length}</Text>
